package spaceShooter.entities.bonuses;
...
public class Bonus extends spaceShooter.entities.Movable implements Circle {
	...
	public Bonus(double x, double y, int radius, Player player, int numeroBonus) {
		...
		this.spriteBonus=AppLoader.loadPicture("/images/bonuses/bonus"+this.type+".png");
	}
