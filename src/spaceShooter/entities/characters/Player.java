package spaceShooter.entities.characters;
...
import spaceShooter.entities.projectiles.StraightProjectile;
import spaceShooter.util.Circle;

public class Player extends spaceShooter.entities.Movable implements Circle{
	...
	private String nameSprite = "/images/projectiles/playerShot.png";
	...
	public Player(double centerPointX, double centerPointY, int radius, ArrayList<Projectile> ProjectileList) {
		...
		image=AppLoader.loadPicture("/images/ships/En3.png");
		image=image.getScaledCopy(.05f);
		imageInvul = AppLoader.loadPicture("/images/ships/En3Invulnerable.png");
