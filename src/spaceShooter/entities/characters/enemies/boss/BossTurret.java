package spaceShooter.entities.characters.enemies.boss;
...
import spaceShooter.entities.projectiles.StraightProjectileAnimated;
...
public class BossTurret extends Enemy {
	...
	public BossTurret(double x, double y, Player player,ArrayList<Projectile> projectiles,double speedX,double speedY, Enemy parent, Image img){
		...
		nameSpriteList.add("/images/projectiles/bossShot00.png");
		nameSpriteList.add("/images/projectiles/bossShot01.png");
		nameSpriteList.add("/images/projectiles/bossShot02.png");
		nameSpriteList.add("/images/projectiles/bossShot03.png");
	}
