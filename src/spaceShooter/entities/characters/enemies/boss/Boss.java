...
public class Boss extends Enemy {
	...
	double startY;
	boolean arrive;
	private String nameSprite = "/images/projectiles/bossShot01.png";

	public Boss(World world, double x, double y, Player player, ArrayList<Projectile> projectiles, Image[] img){
