package spaceShooter.entities.characters.enemies;
...
public class EnemyRandom extends Enemy{
	...
	private int i;
	private String nameSprite = "/images/projectiles/shot.png";
	...
	public EnemyRandom(double x, double y, Player player, ArrayList<Projectile> projectiles, double xbox, double ybox, double widthbox, double heightbox) {
		...
		this.score=40;
		this.i=0;
		image=AppLoader.loadPicture("/images/ships/enemy4.png");
